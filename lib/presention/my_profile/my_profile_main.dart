              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    if (state.level >= 2.0 && state.level <= 3.0) LinearProgressBarChild(percentage: state.level - 2),
                    if (state.level >= 3.0 && state.level <= 4.0) LinearProgressBarChild(percentage: state.level - 3),
                    if (state.level >= 4.0 && state.level <= 5.0) LinearProgressBarChild(percentage: state.level - 4),
                    if (state.level >= 5.0 && state.level <= 6.0) LinearProgressBarChild(percentage: state.level - 5),
                  ],
                ),
              ],
            );
