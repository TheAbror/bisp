...
class SpriteSheetHero {
  ...
  static late SpriteSheet hero6;
  static late SpriteSheet hero7;
  static late SpriteSheet spriteSheetEmotes;

  static load() async {
    hero1 = await _create('heroes/student1.png', columns: 4);
    hero2 = await _create('heroes/student2.png', columns: 4);
    hero3 = await _create('heroes/student3.png', columns: 4);
    hero4 = await _create('heroes/student4.png', columns: 4);
    hero5 = await _create('heroes/student5.png', columns: 4);
    hero6 = await _create('heroes/teacher1.png', columns: 4);
    hero7 = await _create('heroes/teacher2.png', columns: 4);
    spriteSheetEmotes = await _create('emotes/emotes1.png', rows: 10, columns: 8);
  }

  static Future<SpriteSheet> _create(String path, {int columns = 3, int rows = 8}) async {
